...
@{ITEMS_DESC}    "Summer Dresses"        "Printed Summer Dress"        "Printed Chiffon Dress"
...
#DESAFIO 3
Conferir se os produtos de sub-categoria "${SUBCATEGORIA}" foram mostrados na página
    Page Should Contain Image       xpath=//*[@id="center_column"]/h1/spam[contains(text(),"${ITEMS_DESC[0]}")]
    Page Should Contain Image       xpath=//*[@id="center_column"]/ul/li[1]/div/div[2]/h5/a[@title="${ITEMS_DESC[1]}")]
    Page Should Contain Image       xpath=//*[@id="center_column"]/ul/li[2]/div/div[2]/h5/a[@title="${ITEMS_DESC[1]}")]
    Page Should Contain Image       xpath=//*[@id="center_column"]/ul/li[3]/div/div[2]/h5/a[@title="${ITEMS_DESC[2]}")]
